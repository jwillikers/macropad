      ...
      with pkgs;
      {
        apps = {
          ...
          install = {
            ...
            #     pkgs.writers.writeNu "install-circuitpython" ''
            ...
            #   type = "app";
            #   program = builtins.toString (
            #     pkgs.writers.writeNu "install-macropad" ''
            #       let serial_device = (
          ...
          # default = self.apps.${system}.install.circuitpython;
        };
        ...
        packages = {
          macropad = callPackage ./package.nix { };
        };
